...
export const WebSocket = ({ notification }) => {
  ...
  return (
    <div>
      ...
      <br />
      <br /> */}
      <h1 className="text-3xl font-bold tracking-tight text-gray-900">Bitcoin to USD</h1>
      <br />
      <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" onClick={handleClickSendMessage} disabled={readyState !== ReadyState.OPEN}>
